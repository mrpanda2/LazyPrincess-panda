...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1002168327301'))
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','pandawiz2') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','darkmovies2') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','darkmovies2') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','darkmovies2')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+-CWDhekYZiwwMmZl") #[ without @ ]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '5b316945a9c75cb7ede237b5f2d0cef50aadd0e2')
...
lazy_groups = environ.get('LAZY_GROUPS','-1002170681398')
